...
def translate(api_id, api_key, word, to_lang):
    ...
    for retry in range(10):
        ...
        if 'error_code' in json_reads:    # 返回错误码
            ...
            content = json_reads['trans_result'][0]['dst']
            lllist = ["\\", "/", "|", "<", ">", "?", ":", "！", "”", "*", "…"]
            for ii in lllist:
                content = content.replace(ii, '')
...
if __name__ == '__main__':
    appid = 20211030000986906
    appkey = 'rv0gICLiJIWIUAa1j8aP'
    janpenese="9"
    a = translate(api_id=appid,api_key=appkey,word=janpenese,to_lang='zh')
    print(a)
