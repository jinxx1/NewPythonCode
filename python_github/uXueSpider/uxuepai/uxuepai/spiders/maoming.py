...
class MaomingSpider(scrapy.Spider):
    name = 'maoming'
    allowed_domains = ['jxj.maoming.gov.cn']
    start_urls = ['http://jxj.maoming.gov.cn/map.php']
