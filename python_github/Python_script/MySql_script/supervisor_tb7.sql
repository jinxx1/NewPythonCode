...
-- ----------------------------
-- Table structure for supervisor_tb7
-- ----------------------------
DROP TABLE IF EXISTS `supervisor_tb7`;
CREATE TABLE `supervisor_tb7`  (
...
) ENGINE = InnoDB AUTO_INCREMENT = 107690 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci ROW_FORMAT = Dynamic;
