...
-- ----------------------------
-- Table structure for supervisor_tb3
-- ----------------------------
DROP TABLE IF EXISTS `supervisor_tb3`;
CREATE TABLE `supervisor_tb3`  (
...
) ENGINE = InnoDB AUTO_INCREMENT = 60330 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci ROW_FORMAT = Dynamic;
