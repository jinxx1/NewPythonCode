...
-- ----------------------------
-- Table structure for supervisor_tb4
-- ----------------------------
DROP TABLE IF EXISTS `supervisor_tb4`;
CREATE TABLE `supervisor_tb4`  (
...
) ENGINE = InnoDB AUTO_INCREMENT = 52835 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci ROW_FORMAT = Dynamic;
