...
font_path = '/usr/share/fonts/wqy-zenhei/wqy-zenhei.ttc' # 为matplotlib设置中>文字体路径没
...
wc = WordCloud(font_path=font_path,  # 设置字体
               ...
               random_state=42,
               width=1000, height=800, margin=2,# 设置图片默认的大小,但是如果使>用背景图片的话,那么保存的图片大小将会按照其大小保存,margin为词语边缘距离
               )
