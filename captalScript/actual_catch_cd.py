...
logging.basicConfig(filename='logger_catch.log',level=logging.INFO)
...
def actual_process(source):
    ...
    sql = "select a.page_title, b.content, a.purchase_date, a.site, a.guild_id, a.business_type, a.minor_business_type,a.id from ztbInfo as a left join ztbInfoContent as b on a.id = b.info_id where a.id > %s and a.guild_id = %s LIMIT 5" % (int(start_id),source)
    ...
    if len(objs) > 0:
        ...
        url = 'http://ztb.uxuepai.net:9120/service/api/newInfoDataHandle/handleProjectAndPackageFile'
        csvFile = 'D:/jinxiaoDB/historyOutput/' + outFile + '.csv'
        csvDetailFile = 'D:/jinxiaoDB/historyOutput/' + outFile + 'detail.csv'
